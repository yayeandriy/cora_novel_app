...
jest.mock("@angular/core", () => ({ Injectable: () => (x) => x }));
...
describe('ProjectViewComponent - Drafts Feature', () => {
    ...
    describe('Draft Operations via Service', () => {
        ...
        it('should handle updateDraft with payload', async () => {
            ...
            const result = await mockInvoke('draft_update', {
                id: 1,
    ...
    describe('Error Handling', () => {
        it('should propagate errors from service', async () => {
            ...
            await expect(mockInvoke('draft_create', {
                docId: 10,
        ...
        it('should handle network errors', async () => {
            ...
            mockInvoke.mockRejectedValue(error);
            await expect(mockInvoke('draft_list', { docId: 10 })).rejects.toThrow('Network error');
        });
    });
});
